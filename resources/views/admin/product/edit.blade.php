    ...
    <div class="w-[1070px] mx-auto mt-10 bg-white p-7 rounded-lg">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex justify-end">
                <a href="{{ route('product.create') }}" class="mr-10 text-white bg-gradient-to-br from-green-600 to-green-300 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2">Back</a>
            </div>
        </div>
